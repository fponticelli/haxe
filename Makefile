...
HAXELIB_LFLAGS= -Wl,-rpath,/opt/homebrew/lib
endif
...
haxelib_unix:
	...
	$(CC) $(CURDIR)/extra/haxelib_src/run.c -o $(HAXELIB_OUTPUT) -I/opt/homebrew/include -L/opt/homebrew/lib -lneko $(HAXELIB_LFLAGS)
